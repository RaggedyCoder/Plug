...
public interface PlugConverter<From, To> {
    ...
    abstract class Factory {
        @Nullable
        public PlugConverter<PlugResponseBody, ?> responseBodyConverter(Type type, Annotation[] annotations, Plug plug) {
            return null;
        }

        @Nullable
        public PlugConverter<?, PlugRequestBody> requestBodyConverter(Type type, Annotation[] parameterAnnotations, Annotation[] methodAnnotations, Plug plug) {
            return null;
        }
